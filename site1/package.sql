...
CREATE OR REPLACE PACKAGE prediction AS
	...
	FUNCTION KNN(
        k IN number, 
        pw IN IRIS2.petal_width%TYPE,
        pl IN IRIS2.petal_length%TYPE,
        sw IN IRIS2.sepal_width%TYPE,
        sl IN IRIS2.sepal_width%TYPE
    )
	RETURN number;
...
CREATE OR REPLACE PACKAGE BODY prediction AS
	...
	RETURN number
	IS
        pws IRIS2.petal_width%TYPE;
        pls IRIS2.petal_length%TYPE;
        sws IRIS2.sepal_width%TYPE;
        sls IRIS2.sepal_width%TYPE;
